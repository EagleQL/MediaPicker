...
public class MediaPickerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.btn_open_gallery:
                ...
                if (rb_crop_square.isChecked()) {
                    mediaPicker.setStyle(CropImageView.Style.RECTANGLE);
                    ...
                    mediaPicker.setFocusWidth(width);
                    mediaPicker.setFocusHeight(height);
                } else if (rb_crop_circle.isChecked()) {
                    mediaPicker.setStyle(CropImageView.Style.CIRCLE);
                    ...
                    mediaPicker.setFocusWidth(radius * 2);
                    mediaPicker.setFocusHeight(radius * 2);
                }

                mediaPicker.setOutPutX(Integer.valueOf(et_outputx.getText().toString()));
                mediaPicker.setOutPutY(Integer.valueOf(et_outputy.getText().toString()));
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case R.id.cb_show_camera:
                mediaPicker.setShowCamera(isChecked);
                break;
            case R.id.cb_crop:
                mediaPicker.setCrop(isChecked);
                break;
            case R.id.cb_isSaveRectangle:
                mediaPicker.setSaveRectangle(isChecked);
                break;
        }
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        mediaPicker.setSelectLimit(progress);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == MediaPicker.RESULT_CODE_ITEMS) {
            if (data != null && requestCode == 100) {
                ArrayList<MediaItem> images = (ArrayList<MediaItem>) data.getSerializableExtra(MediaPicker.EXTRA_RESULT_ITEMS);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                imageView = new ImageView(MediaPickerActivity.this);
